...
import 'package:practice/ui/pages/restaurant_product_list_screen/product_list_fragments/empty_product_list_fragment.dart';
import 'package:practice/ui/pages/restaurant_product_list_screen/product_list_fragments/product_list_fragment.dart';
    ...
    return BlocBuilder<CatalogBloc, CatalogState>(
      ...
      builder: (context, state) {
        if (state is ChangedCategoryState) {
          ...
          productBloc.add(
              ListLoadingEvent.loadItems(loadingRequest: RestaurantGetRequest(
